...
public class FrequencyMethod {
    public static void main(String[] args) {
        ...
        System.out.println(Collections.frequency(letters, 'z'));//0
        ...
        ArrayList<String> list = new ArrayList<>( Arrays.asList(s.split(""))); // [a, a, b, b, b, a, b, e, i, f, f, c, a]
        /*
        ...
        System.out.println(Collections.frequency(list, "a")); //4
