...
public class StringUtil {
    ...
    //palindrome: same as forwards and backwards
...
Ex:     Input:     jamES
    ...
    Camel Case:
     ...
     create a method that will accept a String, of words separated by spaces, and return a camel case version of the String where the first letter of each word is Uppercase and the rest of the word is in lowercase. Exception: First word starts with lowercase
