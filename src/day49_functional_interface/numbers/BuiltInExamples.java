...
public class BuiltInExamples {
    public static void main(String[] args) {
        ...
        List<Integer> nums = new ArrayList<>(Arrays.asList(1,5,21,6,12,4,15,1,2,5,1,2,4,1,5,12,3,5,12,32,5,15,32));

        nums.removeIf(isPrime);
        System.out.println("nums = " + nums);

        List<Integer> nums2 = new ArrayList<>(Arrays.asList(1,5,21,6,12,4,15,1,2,5,1,2,4,1,5,12,3,5,12,32,5,15,32));

        nums2.removeIf(p -> p < 10);
